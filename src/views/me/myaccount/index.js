    ...
    <div className='myaccount-body'>
      ...
      {value === 0 && <div className="tab-panel-item">
          ...
          <div className='myaccount-add-address'>
            <button onClick={showModal} className='myaccount-add-address-button'>Add a new address</button>
            ...
            return(
              <div>
                <div className='myaccount-title'>
                  ...
                  <p className='myaccount-title-3'>{profileItem.goal}</p>
                </div>
                <div className='myaccount-title'>
                  <p className='myaccount-title-3'>My Diet Type:</p>
                  <p className='myaccount-title-3'>{profileItem.typeOfEater}</p>
                </div>
                <div className='myaccount-title'>
                  <p className='myaccount-title-3'>My Dietary Preferences:</p>
                  <p className='myaccount-title-3'>{profileItem.dietaryPreference}</p>
                </div>
              </div>
